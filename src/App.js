...
function handleClearTodos() {
  ...
  return (
    <div className="wrapper">
      ...
      <div className="counter">{todos.filter(todo => !todo.complete).length} tasks</div>
      <div className="side"><img className="img" src="https://res.cloudinary.com/octavian2111/image/upload/v1619986415/images_1_tamyw5.png" alt="calm" />
